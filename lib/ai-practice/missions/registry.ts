...
const MISSIONS: readonly OralMission[] = [
  {
    ...
    category: 'interview',
    recommendedCefr: 'B1',
    context: 'Entrevista laboral para el puesto deseado.',
    communicativeGoal: 'Presentarte y relatar tu experiencia profesional clave.',
...
`.trim(),
  },
  {
    ...
    category: 'service',
    recommendedCefr: 'A2',
    context: 'Cafetería en una ciudad de habla inglesa.',
    communicativeGoal: 'Pedir un café y confirmar tus preferencias.',
...
`.trim(),
  },
  {
    ...
    category: 'service',
    recommendedCefr: 'A2',
    context: 'Mostrador de check-in en un aeropuerto.',
    communicativeGoal: 'Completar el check-in y solicitar asiento.',
...
`.trim(),
  },
  {
    ...
    category: 'service',
    recommendedCefr: 'A2',
    context: 'Consulta médica de atención general.',
    communicativeGoal: 'Describir tus síntomas para recibir asistencia.',
...
`.trim(),
  },
  {
    ...
    category: 'service',
    recommendedCefr: 'A2',
    context: 'Tienda de ropa buscando una prenda.',
    communicativeGoal: 'Pedir ayuda para encontrar y probar ropa.',
...
`.trim(),
  },
  {
    ...
    category: 'workplace',
    recommendedCefr: 'B1',
    context: 'Revisión de código sobre un Pull Request.',
    communicativeGoal: 'Explicar decisiones de código y proponer mejoras.',
...
`.trim(),
  },
  {
    ...
    category: 'workplace',
    recommendedCefr: 'B1',
    context: 'Reunión diaria de seguimiento con el equipo.',
    communicativeGoal: 'Reportar avance de ayer, hoy y bloqueos.',
...
`.trim(),
  },
  {
    ...
    category: 'workplace',
    recommendedCefr: 'B2',
    context: 'Explicación técnica a un Product Manager.',
    communicativeGoal: 'Explicar un diseño técnico y sus compromisos.',
...
`.trim(),
  },
  {
    ...
    category: 'social',
    recommendedCefr: 'B1',
    context: 'Práctica de conversación fluida continua.',
    communicativeGoal: 'Encadenar ideas fluidas usando conectores simples.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B1',
    context: 'Pregunta inicial de entrevista laboral.',
    communicativeGoal: 'Dar tu elevator pitch sobre trayectoria y metas.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B2',
    context: 'Entrevista sobre arquitectura Full Stack.',
    communicativeGoal: 'Diseñar una función full-stack de BD a frontend.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B2',
    context: 'Entrevista sobre rendimiento y UI frontend.',
    communicativeGoal: 'Defender decisiones de rendimiento web y estado.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B2',
    context: 'Entrevista sobre escalabilidad y bases de datos.',
    communicativeGoal: 'Optimizar BD y diseñar endpoints resilientes.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B1',
    context: 'Explicación detallada de un proyecto clave.',
    communicativeGoal: 'Presentar un proyecto: problema, stack y lecciones.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B2',
    context: 'Resolución de una crisis o incidente laboral.',
    communicativeGoal: 'Relatar un reto laboral superado con el método STAR.',
...
`.trim(),
  },
  {
    ...
    category: 'interview',
    recommendedCefr: 'B1',
    context: 'Turno de preguntas del candidato al equipo.',
    communicativeGoal: 'Hacer preguntas clave sobre la cultura del equipo.',
...
`.trim(),
  },
  {
    ...
    category: 'social',
    recommendedCefr: 'B1',
    context: 'Charla casual en un evento de desarrolladores.',
    communicativeGoal: 'Hacer networking y hablar sobre proyectos en un meetup.',
...
`.trim(),
  },
  {
    ...
    category: 'service',
    recommendedCefr: 'A2',
    context: 'Contacto con administración por una avería.',
    communicativeGoal: 'Reportar una avería urgente en tu vivienda.',
