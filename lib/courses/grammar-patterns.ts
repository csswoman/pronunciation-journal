...
const a1Patterns: GrammarPattern[] = [
  ...
  { order: 22, id: "present-simple-vs-continuous", title: "Present Simple vs Present Continuous — hábitos vs ahora", deckSlug: "a1-presente-simple-vs-continuo" },
  { order: 23, id: "prep-place", title: "Preposiciones de lugar — in/on/under/at", deckSlug: "a1-preposiciones-lugar-tiempo" },
  { order: 24, id: "prep-time", title: "Preposiciones de tiempo — in/on/at", deckSlug: "a1-preposiciones-lugar-tiempo" },
  { order: 25, id: "frequency-adverbs", title: "Adverbios de frecuencia — always/usually/never", deckSlug: "a1-adverbios-frecuencia" },
  { order: 26, id: "basic-conjunctions", title: "Conjunciones básicas — and/but/or", deckSlug: "a1-conjunciones-basicas" },
  { order: 27, id: "countable-uncountable", title: "Sustantivos contables e incontables", deckSlug: "a1-contables-incontables" },
...
const a2Patterns: GrammarPattern[] = [
  ...
  { order: 7, id: "used-to", title: "Used to — hábitos y estados pasados", deckSlug: "b1-habitos-pasados" },
  { order: 8, id: "zero-conditional", title: "Condicional cero — hechos generales y reglas", deckSlug: "b1-condicional-cero" },
  { order: 9, id: "present-continuous-future", title: "Presente continuo para planes futuros", deckSlug: "a2-presente-continuo-futuro" },
  { order: 10, id: "going-to", title: "Going to — planes futuros", deckSlug: "a2-will-going-to" },
  { order: 11, id: "will", title: "Will — predicciones y decisiones", deckSlug: "a2-will-going-to" },
  { order: 12, id: "future-forms-contrast", title: "Contraste de futuro — will vs going to vs presente continuo", deckSlug: "a2-futuro-contraste" },
  { order: 13, id: "comparatives", title: "Adjetivos comparativos — -er / more", deckSlug: "a2-descripciones-comparaciones" },
  { order: 14, id: "superlatives", title: "Adjetivos superlativos — -est / most", deckSlug: "a2-cuantificadores-superlativos" },
  { order: 15, id: "adjective-order", title: "Adjetivos antes del sustantivo", deckSlug: "a2-orden-adjetivos" },
  { order: 16, id: "adverbs-ly", title: "Adverbios de modo — -ly", deckSlug: "a2-adverbios-expresiones-tiempo" },
  { order: 17, id: "adverbs-degree", title: "Adverbios de grado — very/really/quite", deckSlug: "a2-adverbios-grado" },
  { order: 18, id: "too-enough", title: "Too / enough", deckSlug: "a2-adverbios-expresiones-tiempo" },
  { order: 19, id: "some-any", title: "Some / any", deckSlug: "a2-cuantificadores-esenciales" },
  { order: 20, id: "indefinite-pronouns", title: "Pronombres indefinidos — somebody, anything, nowhere", deckSlug: "a2-pronombres-indefinidos" },
  { order: 21, id: "much-many", title: "Much / many / a lot of", deckSlug: "a2-cuantificadores-esenciales" },
  { order: 22, id: "few-little", title: "(A) few / (a) little", deckSlug: "a2-cuantificadores-superlativos" },
  { order: 23, id: "another-other-others", title: "Another, other, others y the other", deckSlug: "a2-another-other-others" },
  { order: 24, id: "possessive-pronouns", title: "Pronombres posesivos — mine/yours…", deckSlug: "a1-posesivos" },
  { order: 25, id: "have-to", title: "Have to — obligación", deckSlug: "a2-obligacion-prohibicion" },
  { order: 26, id: "must", title: "Must / mustn't", deckSlug: "a2-obligacion-prohibicion" },
  { order: 27, id: "should", title: "Should / shouldn't — consejos", deckSlug: "a2-modales-consejo-posibilidad" },
  { order: 28, id: "so-because", title: "So / because — causa y resultado", deckSlug: "a2-conjunciones-verbos" },
  { order: 29, id: "infinitive-purpose", title: "Infinitivo de propósito — to + verbo", deckSlug: "a2-infinitivos-presente-continuo" },
  { order: 30, id: "like-ing", title: "Like/love/hate + -ing", deckSlug: "a1-preferencias-habilidades" },
  { order: 31, id: "collocations-common", title: "Colocaciones comunes — make, do, take, have", deckSlug: "a2-colocaciones-comunes" },
  { order: 32, id: "prep-movement", title: "Preposiciones de movimiento — to/into/through", deckSlug: "a1-audio-preposiciones" },
  { order: 33, id: "reflexive-pronouns", title: "Pronombres reflexivos — myself/yourself…", deckSlug: "a2-pronombres-reflexivos" },
  { order: 34, id: "one-ones", title: "One / ones — sustitución", deckSlug: "a2-one-ones" },
];

const b1Patterns: GrammarPattern[] = [
  { order: 1, id: "present-perfect-intro", title: "Presente perfecto — ever/never y experiencias", deckSlug: "a2-presente-perfecto-experiencias" },
  { order: 2, id: "pp-vs-past-simple", title: "Presente perfecto vs pasado simple", deckSlug: "b1-presente-perfecto-preposiciones" },
  { order: 3, id: "pp-for-since", title: "Presente perfecto con for / since", deckSlug: "b1-presente-perfecto-preposiciones" },
  { order: 4, id: "present-perfect-continuous", title: "Presente perfecto continuo", deckSlug: "b1-presente-perfecto-continuo" },
  { order: 5, id: "articles-superlative-zero", title: "Artículos — superlativos y artículo cero", deckSlug: "b1-articulos-superlativos-cero" },
  { order: 6, id: "comparative-modifiers", title: "Modificadores de comparativos — much/far/a bit + -er", deckSlug: "b1-modificadores-comparativos" },
  { order: 7, id: "as-as", title: "Comparaciones — as … as / not as … as", deckSlug: "b1-comparativos-planes-futuros" },
  { order: 8, id: "so-vs-such", title: "So vs Such — so beautiful vs such a beautiful day", deckSlug: "b1-so-vs-such" },
  { order: 9, id: "defining-relatives", title: "Oraciones de relativo especificativas — who/which/that", deckSlug: "b1-pronombres-clausulas-relativas" },
  { order: 10, id: "dependent-prepositions", title: "Preposiciones dependientes — tras adjetivos/verbos", deckSlug: "b1-preposiciones-dependientes" },
  { order: 11, id: "first-conditional", title: "Primer condicional", deckSlug: "b1-primer-condicional-pasado-continuo" },
  { order: 12, id: "future-continuous", title: "Futuro continuo", deckSlug: "b1-futuro-continuo" },
  { order: 13, id: "future-time-clauses", title: "Cláusulas de tiempo futuro — when/as soon as + presente", deckSlug: "b1-primer-condicional-pasado-continuo" },
  { order: 14, id: "gerunds-infinitives", title: "Gerundios e infinitivos después de verbos", deckSlug: "b1-gerundios-infinitivos" },
  { order: 15, id: "gerund-infinitive-meaning", title: "Gerundio vs infinitivo — cambio de significado", deckSlug: "b2-gerundio-significado" },
  { order: 16, id: "indirect-questions", title: "Preguntas indirectas", deckSlug: "b1-adjetivos-preguntas-indirectas" },
  { order: 17, id: "subject-vs-object-questions", title: "Preguntas de sujeto vs objeto — Who called you? vs Who did you call?", deckSlug: "b1-preguntas-sujeto-objeto" },
  { order: 18, id: "contrast-connectors", title: "Conectores de contraste — although/however", deckSlug: "b1-conectores-discurso" },
  { order: 19, id: "purpose-connectors", title: "Conectores de propósito — in order to, so as to, so that", deckSlug: "b1-conectores-proposito" },
  { order: 20, id: "modals-deduction", title: "Modales de deducción — must/might/can't", deckSlug: "b1-modales-deduccion" },
  { order: 21, id: "passive-voice", title: "Voz pasiva — presente y pasado simple", deckSlug: "b1-voz-pasiva-consejos" },
  { order: 22, id: "past-perfect", title: "Pasado perfecto", deckSlug: "b1-pasado-perfecto" },
  { order: 23, id: "phrasal-verbs", title: "Verbos frasales — separables e inseparables", deckSlug: "b1-phrasal-verbs-tipos" },
  { order: 24, id: "quantifiers", title: "Cuantificadores — all/most/none/each/every", deckSlug: "b1-cuantificadores" },
  { order: 25, id: "question-tags", title: "Coletillas interrogativas", deckSlug: "b1-confirmacion-posibilidades" },
  { order: 26, id: "reported-statements", title: "Estilo indirecto — afirmaciones", deckSlug: "b1-estilo-indirecto" },
  { order: 27, id: "second-conditional", title: "Segundo condicional", deckSlug: "b1-segundo-condicional" },
  { order: 28, id: "verb-patterns-ing", title: "Patrones de verbos — stop/remember/try + -ing/infinitivo", deckSlug: "b1-gerundios-infinitivos" },
  { order: 29, id: "word-formation", title: "Formación de palabras — prefijos y sufijos", deckSlug: "b1-formacion-palabras" },
  { order: 30, id: "both-either-neither", title: "Both / either / neither", deckSlug: "b1-both-either-neither" },
  { order: 31, id: "make-let-allow", title: "Make / let / allow", deckSlug: "b1-make-let-allow" },
  { order: 32, id: "wish-present", title: "Wish + pasado simple — lamentos sobre el presente", deckSlug: "b1-wish-presente" },
  { order: 33, id: "would-past-habits", title: "Would — acciones repetidas en el pasado", deckSlug: "b1-habitos-pasados" },
];
...
const b2Patterns: GrammarPattern[] = [
  ...
  { order: 9, id: "inversion-negative-adverbs", title: "Inversión tras adverbios negativos", deckSlug: "b2-inversion-enfasis" },
  { order: 10, id: "mixed-conditionals", title: "Condicionales mixtos", deckSlug: "b2-condicionales-mixtos" },
  { order: 11, id: "non-defining-relatives", title: "Cláusulas relativas explicativas", deckSlug: "b2-relativas-no-definitorias" },
  { order: 12, id: "participle-clauses", title: "Cláusulas de participio", deckSlug: "b2-clausulas-participio" },
  { order: 13, id: "passive-reporting", title: "Reportaje pasivo — it is said that…", deckSlug: "b2-pasiva-reportada" },
  { order: 14, id: "passive-all-tenses", title: "Voz pasiva — todos los tiempos", deckSlug: "b2-pasiva-completa" },
  { order: 15, id: "perfect-modals", title: "Modales perfectos — should/must/could have + pp", deckSlug: "b2-modales-pasado" },
  { order: 16, id: "speculation-present-vs-past", title: "Deducción en presente vs pasado — must be vs must have been", deckSlug: "b2-deduccion-presente-pasado" },
...
export type GrammarPatternLevel = "a1" | "a2" | "b1" | "b2" | "c1" | "c2";
...
export const NEW_PATTERN_DECK_SLUGS = [
  ...
  "a1-presente-simple-vs-continuo",
  ...
  "a2-futuro-contraste",
  "a2-colocaciones-comunes",
  "a2-pronombres-indefinidos",
  "a2-another-other-others",
  ...
  "b1-futuro-continuo",
  "b1-preguntas-sujeto-objeto",
  "b1-formacion-palabras",
  "b1-so-vs-such",
  "b1-conectores-proposito",
  "b1-pasado-perfecto",
  "b1-condicional-cero",
