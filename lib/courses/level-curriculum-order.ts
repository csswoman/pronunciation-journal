...
const LESSON_BY_SLUG: Record<string, Omit<CourseInput, "g">> = {
  ...
  "a1-demostrativos": { t: "Demostrativos", p: 1, keywords: "this · that · these · those", tag: "PRÁCTICA", duration: "4 min", subgroup: "PRONOMBRES Y ARTÍCULOS" },
  "a1-plurales": { t: "Plurales regulares e irregulares", p: 1, keywords: "cats · boxes · children", tag: "PRONUNCIACIÓN", duration: "8 min", subgroup: "SUSTANTIVOS Y POSESIÓN" },
  "a1-genitivo-sajon": { t: "El posesivo con 's", p: 1, keywords: "Ana's book · the dog's tail", tag: "CONCEPTO", duration: "5 min", subgroup: "SUSTANTIVOS Y POSESIÓN" },
  "a1-posesivos": { t: "Adjetivos posesivos", p: 1, keywords: "my · your · his · her", tag: "PRÁCTICA", duration: "4 min", subgroup: "SUSTANTIVOS Y POSESIÓN" },
  "a1-construccion-oraciones": { t: "Partes de la oración", p: 1, keywords: "noun · verb · adjective", tag: "REPASO", duration: "9 min", subgroup: "SUSTANTIVOS Y POSESIÓN" },
