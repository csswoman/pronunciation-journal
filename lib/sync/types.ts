...
export type SyncTable = 'user_contrast_progress' | 'answer_history' | 'activity_sessions' | 'ai_conversations' | 'user_learning_state' | 'ai_events' | 'word_bank' | 'topic_srs' | 'journal_entries' | 'tracked_items'
