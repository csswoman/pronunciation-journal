...
const exits = [
  ...
  { surface: 'chunks', owner: 'chunk_srs', answerId: 'generated per submit (PracticeSession)', activity: 'activity_sessions', reconcile: 'canonical chunk id', forbidden: 'exposure', tier: 'hook-runtime', file: 'components/practice/session/__tests__/useSessionState.roundtrip.test.tsx', caseName: 'writes answers, canonical chunk SRS and reconciles only the practised chunk step' },
  { surface: 'courses', owner: 'topic_srs', answerId: 'generated per call; retry is not replay-safe', activity: 'activity_sessions', reconcile: 'exact study deck', forbidden: 'navigation', tier: 'runtime', file: 'lib/learning-loop/__tests__/producer-roundtrip.integration.test.ts', caseName: 'writes each answer and reconciles only the exact study deck' },
