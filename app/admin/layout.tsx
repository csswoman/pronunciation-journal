  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "var(--page-bg)" }}>
        <p className="text-sm text-fg-muted">Checking permissions…</p>
      </div>
    );
  }
  ...
  if (!isPremium) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4" style={{ backgroundColor: "var(--page-bg)" }}>
        ...
        <p className="text-lg font-semibold text-fg">Access restricted</p>
        <p className="text-sm text-fg-muted">This section requires admin role.</p>
      </div>
    );
  }
