...
export function QuickAddSuccessState({ word }: { word: string }) {
  return (
    <div className="flex flex-col items-center gap-4 px-[var(--layout-card-pad)] py-12">
      ...
      <div className="text-center">
        ...
        <p className="mt-1 flex items-center justify-center gap-1.5 text-body-sm text-fg-muted"><Sparkles size={13} aria-hidden />Preparando significado, IPA y ejemplo.</p>
      </div>
    </div>
  );
}
