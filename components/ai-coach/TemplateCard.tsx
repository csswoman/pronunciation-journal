...
export const TEMPLATES: TemplateDefinition[] = [
  {
    ...
    description: "Habla libremente de cualquier tema y mejora de forma natural.",
    Icon: MessageCircle,
    color: "var(--primary)",
  ...
  },
  {
    ...
    description: "Escribe y recibe correcciones con explicaciones.",
    Icon: CheckCheck,
    color: "var(--success)",
  ...
  },
  {
    ...
    description: "Responde preguntas y amplía tu vocabulario.",
    Icon: ClipboardList,
    color: "var(--error)",
  ...
  },
  {
    ...
    title: "Personalizado",
    description: "Práctica adaptada a tus objetivos y nivel.",
    Icon: Star,
    color: "var(--warning)",
