          ...
          <Fragment key={i}>
            ...
            {i < blankCount && (
              <input
                ...
                className="border-b-2 outline-none bg-transparent text-center px-1 font-semibold focus:border-[color:var(--primary)] focus-visible:outline-2 focus-visible:outline-[var(--primary)] focus-visible:outline-offset-2 rounded-sm transition-colors"
