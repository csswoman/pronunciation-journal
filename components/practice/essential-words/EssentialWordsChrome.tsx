    ...
    <div className="flex items-center justify-between gap-3 pb-2">
      ...
      {speaking ? (
        <button
          ...
          className="flex size-9 items-center justify-center rounded-full text-fg-subtle transition-colors duration-150 ease-out-quart focus-ring hover:bg-surface-raised hover:text-fg-muted"
        >
