...
| 067 | Build a pronunciation diagnostic and first-week prescription | P1 product/pedagogy | L | 060, 061, 063, 066 | IN PROGRESS (2026-07-23: implementation, API/offline persistence/RLS, focused tests, typecheck and token lint verified; manual light/dark/custom-hue UI check remains. 2026-07-25: acoustic vowel scoring RESOLVED not-ship — 071 benchmark ran to completion with a NO-SHIP verdict for all 4 v1 vowel contrasts; vowels remain `not_measured` permanently for this evaluator design, not pending. Item variety split to 072) |
