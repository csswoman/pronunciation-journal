/**
 * One-shot generator for public/essential-words/words-*.json
 * Run: node scripts/essential-words/generate-chunks.mjs
 */
import fs from "fs";
...
function main() {
  ...
  const outDir = path.join(ROOT, "public/essential-words");
