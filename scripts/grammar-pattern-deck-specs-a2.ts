...
export const A2_DECK_SPECS: DeckSpec[] = [
  ...
  {
    slug: "a2-futuro-contraste",
    eyebrow: "A2 · Tiempos verbales",
    title: "Contraste de futuro",
    emphasis: "will vs going to vs presente continuo",
    goal: "Ya distingues entre decisiones espontáneas (will), planes e intenciones (going to) y citas confirmadas (present continuous).",
    conceptRows: [
      { key: "will", value: "Decisiones al instante, promesas y predicciones · I will help you with that.", highlights: ["will help"] },
      { key: "going to", value: "Planes previas e intenciones claras · I am going to buy a car next month.", highlights: ["going to buy"] },
      { key: "Present Continuous", value: "Planes con hora/lugar o citas agendadas · I am meeting Sarah at 3 PM.", highlights: ["am meeting"] },
    ],
    structureRows: [
      { key: "Will (Espontáneo)", value: "will + verbo base · The phone rings: I'll answer it!", highlights: ["I'll answer"] },
      { key: "Going to (Intención)", value: "be + going to + verbo · She is going to study medicine.", highlights: ["is going to study"] },
      { key: "Continuous (Cita)", value: "be + -ing + tiempo futuro · We are flying to Paris tomorrow.", highlights: ["are flying"] },
    ],
    contextExamples: [
      { key: "Oferta en el momento", value: "Don't worry, I will carry those heavy bags for you." },
      { key: "Plan ya pensado", value: "Next year, we are going to learn how to drive." },
      { key: "Cita médica confirmada", value: "I am seeing the doctor tomorrow at 10 AM." },
    ],
    contrastColumns: [
      { label: "will (Decisión instantánea)", rule: "Tomada en el momento de hablar", examples: ["I'm hungry. I'll make a sandwich."] },
      { label: "going to / Continuous (Plan predeterminado)", rule: "Decidido antes de hablar o agendado", examples: ["I am going to make a sandwich in 10 minutes."] },
    ],
    quickReferenceRows: [
      { key: "will", value: "ofertas ('I'll help'), promesas ('I will call'), predicciones" },
      { key: "going to", value: "intenciones ('I am going to save money'), evidencia presente" },
      { key: "continuous", value: "acuerdos con otras personas o eventos en agenda ('I'm meeting John tonight')" },
    ],
    mistake: { bad: "I am meeting my boss tomorrow, maybe.", good: "I will meet my boss tomorrow, maybe.", note: "si es incierto o espontáneo usa will, el continuo es para citas confirmadas" },
    quiz: [
      { q: "A: The phone is ringing! B: OK, I ___ it.", options: ["will answer", "am going to answer"], answer: 0, explain: "Decisión rápida tomada en el momento de hablar: 'will answer'." },
      { q: "We already bought the tickets. We ___ a movie tonight at 8 PM.", options: ["are watching", "will watch"], answer: 0, explain: "Cita/evento con horario y boletos comprados: Present Continuous ('are watching')." },
      { q: "What are your plans for the summer? — I ___ visit my grandparents in Canada.", options: ["am going to", "will"], answer: 0, explain: "Expresa un plan e intención previa: 'am going to'." },
    ],
  },
  {
    slug: "a2-colocaciones-comunes",
    eyebrow: "A2 · Vocabulario y estructuras",
    title: "Colocaciones comunes",
    emphasis: "make, do, take, have",
    goal: "Ya usas correctamente las combinaciones fijas de verbos principales como make, do, take y have.",
    conceptRows: [
      { key: "make", value: "Crear, producir o decidir · make dinner, make a decision, make a mistake", highlights: ["make"] },
      { key: "do", value: "Acciones, tareas o trabajo · do homework, do research, do the dishes", highlights: ["do"] },
      { key: "take", value: "Tomar o realizar ciertas actividades · take a break, take a shower, take photos", highlights: ["take"] },
      { key: "have", value: "Consumir alimentos o tener experiencias · have lunch, have fun, have a chat", highlights: ["have"] },
    ],
    structureRows: [
      { key: "Make + Sustantivo", value: "Don't make noise while studying.", highlights: ["make noise"] },
      { key: "Do + Sustantivo", value: "She does exercise every morning.", highlights: ["does exercise"] },
      { key: "Take + Sustantivo", value: "Let's take a 10-minute break.", highlights: ["take a 10-minute break"] },
      { key: "Have + Sustantivo", value: "We had a great time at the party.", highlights: ["had a great time"] },
    ],
    contextExamples: [
      { key: "Decisiones y errores", value: "Everyone makes mistakes when learning something new." },
      { key: "Rutina de casa", value: "I usually do the housework on Saturday mornings." },
      { key: "Descanso", value: "You look tired, why don't you take a nap?" },
      { key: "Comidas", value: "They are having breakfast in the garden." },
    ],
    contrastColumns: [
      { label: "make (Creación / Resultado)", rule: "Crear algo nuevo o tomar decisiones", examples: ["make a plan / make a cup of tea"] },
      { label: "do (Actividad / Tarea)", rule: "Realizar tareas cotidianas o trabajo", examples: ["do your best / do the cleaning"] },
    ],
    quickReferenceRows: [
      { key: "make", value: "make money, make friends, make an appointment, make progress" },
      { key: "do", value: "do a favor, do business, do yoga, do work" },
      { key: "take", value: "take a risk, take a test, take a seat, take time" },
      { key: "have", value: "have a shower, have a drink, have a problem, have a dream" },
    ],
    mistake: { bad: "I need to do a decision right now.", good: "I need to make a decision right now.", note: "'decision' se combina con el verbo 'make'" },
    quiz: [
      { q: "After working for 4 hours, let's ___ a break.", options: ["take", "do"], answer: 0, explain: "La colocación natural en inglés es 'take a break'." },
      { q: "Did you ___ your homework before going out?", options: ["do", "make"], answer: 0, explain: "Las tareas académicas o domésticas se combinan con 'do' ('do homework')." },
      { q: "Elige la opción que usa la colocación correcta:", options: ["She made a big mistake on her exam.", "She did a big mistake on her exam."], answer: 0, explain: "'mistake' se combina con 'make' ('make a mistake')." },
    ],
  },
  {
    slug: "a2-pronombres-indefinidos",
    eyebrow: "A2 · Pronombres",
    title: "Pronombres indefinidos",
    emphasis: "somebody, anything, nowhere, everybody",
    goal: "Ya refieres personas, cosas y lugares no especificados con compuestos de some, any, no y every.",
    conceptRows: [
      { key: "-body / -one (Personas)", value: "somebody / someone, anybody, nobody, everybody", highlights: ["somebody"] },
      { key: "-thing (Cosas)", value: "something, anything, nothing, everything", highlights: ["something"] },
      { key: "-where (Lugares)", value: "somewhere, anywhere, nowhere, everywhere", highlights: ["somewhere"] },
    ],
    structureRows: [
      { key: "Afirmativo", value: "Somebody is at the door. / I want something to eat.", highlights: ["Somebody", "something"] },
      { key: "Negativo / Pregunta", value: "Did you see anybody? / I don't know anything.", highlights: ["anybody", "anything"] },
      { key: "Forma 'no-' (Verbo afirmativo)", value: "Nobody was at home. / There is nothing left.", highlights: ["Nobody", "nothing"] },
    ],
    contextExamples: [
      { key: "Búsqueda de objetos", value: "I left my keys somewhere in the kitchen." },
      { key: "Pregunta abierta", value: "Is there anything I can do to help you?" },
      { key: "Presencia total", value: "Everybody enjoyed the live concert last night." },
      { key: "Ausencia total", value: "There is nowhere to hide in this room." },
    ],
    contrastColumns: [
      { label: "some- / any-", rule: "some- en afirmativas; any- en preguntas y negativas", examples: ["I have something to say. / Do you have anything to say?"] },
      { label: "no- (Dobles negativas prohibidas)", rule: "Usa verbo en afirmativo con nothing/nobody", examples: ["I know nothing. (no: I don't know nothing)"] },
    ],
    quickReferenceRows: [
      { key: "Verbo en singular", value: "Los pronombres indefinidos llevan verbo singular (Everybody IS happy)." },
      { key: "somebody vs someone", value: "Tienen exactamente el mismo significado; 'someone' es un poco más formal." },
      { key: "any- en afirmativo", value: "Significa 'cualquiera' (Anyone can join the club)." },
    ],
    mistake: { bad: "I didn't see nobody in the park.", good: "I didn't see anybody in the park.", note: "evita la doble negativa; usa anybody con verbos en negativo" },
    quiz: [
      { q: "Is there ___ inside the house?", options: ["anyone", "no one"], answer: 0, explain: "En preguntas se prefiere 'anyone' o 'anybody'." },
      { q: "Everybody in the team ___ excited about the trip.", options: ["is", "are"], answer: 0, explain: "Los pronombres indefinidos rigen verbo en singular ('is')." },
      { q: "I looked for my wallet, but I couldn't find it ___.", options: ["anywhere", "nowhere"], answer: 0, explain: "Tras la negación 'couldn't' corresponde usar 'anywhere'." },
    ],
  },
  {
    slug: "a2-another-other-others",
    eyebrow: "A2 · Determinantes y pronombres",
    title: "Another, other, others",
    emphasis: "another, other, others, the other",
    goal: "Distingues con claridad cuándo usar another, other, others y the other.",
    conceptRows: [
      { key: "another", value: "an + other (uno más o uno diferente en singular) · another cup of coffee", highlights: ["another"] },
      { key: "other", value: "adjetivo con sustantivos en plural · other books", highlights: ["other"] },
      { key: "others", value: "pronombre plural (reemplaza sustantivo) · Some agree, others disagree.", highlights: ["others"] },
      { key: "the other", value: "el otro / la otra (específico o el último restante) · on the other hand", highlights: ["the other"] },
    ],
    structureRows: [
      { key: "another + singular", value: "Can I have another piece of cake?", highlights: ["another piece"] },
      { key: "other + plural", value: "There are other options available.", highlights: ["other options"] },
      { key: "others (sin sustantivo)", value: "Some people stayed, others left.", highlights: ["others"] },
      { key: "the other + singular/plural", value: "Where is the other shoe?", highlights: ["the other shoe"] },
    ],
    contextExamples: [
      { key: "Repetición u oferta", value: "Would you like another slice of pizza?" },
      { key: "Alternativas en plural", value: "Do you have other colors in stock?" },
      { key: "Grupos contrastantes", value: "Some students passed, but others failed." },
      { key: "El restante de un par", value: "I found one glove, but where is the other one?" },
    ],
    contrastColumns: [
      { label: "another (Singular e indeterminado)", rule: "Se usa solo con sustantivos contables singulares", examples: ["another day, another car"] },
      { label: "other (Plural)", rule: "Se usa con sustantivos plurales", examples: ["other days, other cars"] },
    ],
    quickReferenceRows: [
      { key: "another", value: "an + other (NUNCA 'other one car' ni 'an other')" },
      { key: "others", value: "NUNCA lleva sustantivo después (say 'others think', NOT 'others people')" },
      { key: "the other", value: "específico: el segundo de dos elementos" },
    ],
    mistake: { bad: "I want to visit others countries.", good: "I want to visit other countries.", note: "'other' funciona como adjetivo y no lleva 's' delante de un sustantivo plural" },
    quiz: [
      { q: "Could you bring me ___ bottle of water, please?", options: ["another", "other"], answer: 0, explain: "'bottle' es singular contable, requiere 'another'." },
      { q: "Some people like tea, while ___ prefer coffee.", options: ["others", "other"], answer: 0, explain: "Funciona como pronombre plural sin sustantivo posterior → 'others'." },
      { q: "I have two brothers: one is a doctor and ___ is an engineer.", options: ["the other", "another"], answer: 0, explain: "Al referirse al único restante entre dos, se usa 'the other'." },
    ],
  },
];
