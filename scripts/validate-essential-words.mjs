 ...
 *
 * Usage:
 *   node scripts/validate-essential-words.mjs            # validate all chunks
 *   node scripts/validate-essential-words.mjs --json     # machine-readable output
 *
...
const DATA_DIR = join(__dirname, '..', 'public', 'essential-words')
