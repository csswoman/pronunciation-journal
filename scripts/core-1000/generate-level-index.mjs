/**
 * Generates public/core-1000/level-index.json — a slim projection of the Core
 ...
 *   node scripts/core-1000/generate-level-index.mjs
 *
 * `lib/core-1000/__tests__/level-index.test.ts` fails if this file drifts from
...
const DIR = path.join(ROOT, "public", "core-1000");
...
function main() {
  ...
  if (entries.length === 0) {
    console.error("[core-1000] no chunks found — nothing to generate");
    process.exit(1);
  }
  ...
  console.log(`[core-1000] wrote level-index.json — ${index.entries.length} entries, ${kb} KB`);
}
